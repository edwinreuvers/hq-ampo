...
def Force2LEE(fsee,fpee,muspar):
    """
    Force2LEE Computes SEE & PEE length from SEE & PEE force.
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
def Vce2FceDC(vce,q,lcerel,muspar):
    """
    Vce2Fce Computes the CE force based on the force-velocity relationship.
    ...
    return fce, fcerel, [fce_c1, fce_e1], [r_c1, r_e1]

#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
def Fce2VceDC(fce,q,lcerel,muspar):
    """
    Fce2Vce Computes the CE velocity based on the force-velocity relationship.
    ...
    return vce, vcerel, [vce_c1, vce_e1], [r_c1, r_e1,]

# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
def anly_gamma(time, cf, t_stim_on, t_stim_off, stim, parms):
    """
    ...
    gamma0_2 = gamma_rise(t_stim_off_mod, gamma0_1, stim, parms)

    # Compute gamma(t)
    gamma = np.where(
        (time_mod >= 0) & (time_mod < t_stim_off_mod),
        gamma_rise(time_mod, gamma0_1, stim, parms),
        gamma_relax(time_mod - t_stim_off_mod, gamma0_2, parms)
    )
...
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
def gamma_relax(time, gamma0, parms):
    """
...
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
def gamma_rise(time, gamma0, stim, parms):
    """
